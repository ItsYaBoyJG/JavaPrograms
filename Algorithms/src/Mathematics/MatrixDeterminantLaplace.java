...
public class MatrixDeterminantLaplace {
    ...
    public static void main(String[] args) {
        ...
        m = new double[][] {{1, -2, 3}, {4, -5, 6}, {7, -8, 10}};
        ...
        m =new double[][] {{1, -2, 3, 7, 12},{4, -5, 6, 2, 4},{7, -8, 10, 3, 1},{-8, 10, 8, 3, 2},{5, 5, 5, 5, 5}};
    ...
    // This method uses cofactor expansion to compute the determinant of a matrix.
    ...
    // excluding the top row and some selected column.
